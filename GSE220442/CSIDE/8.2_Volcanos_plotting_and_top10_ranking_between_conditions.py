...
region = pd.read_csv(data_path+region_to_plot+'/combined_across_conditions.csv')
...
plt.legend(loc = 1, bbox_to_anchor = (1,0.8), frameon = False,  fontsize = '20')
plt.savefig('volcano_plots/'+region_to_plot+'_volcano_across_conditions.png', dpi = 300, bbox_inches = 'tight', facecolor = 'white')
...
region_sig_nonTE.to_csv('vol_plot_data/'+region_to_plot+'/'+region_to_plot+'_nonTE_rank_meta.csv',index = False)
region_sig_TE.to_csv('vol_plot_data/'+region_to_plot+'/'+region_to_plot+'_TE_rank_meta.csv',index = False)
