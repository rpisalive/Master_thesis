...
counts<- as.data.frame(as.matrix(Matrix::readMM('rawdata/counts.mtx.gz')))
features <- read.delim("rawdata/features.tsv.gz",header=FALSE)
...
#mg detected using aggregate_cell_types to have less than the minimum cell_type_threshold of 1.
...
saveRDS(myRCTD.reps_nc, file = "saved_rds/myRCTD_reps_nc_im.rds")
#myRCTD.reps_nc <- readRDS('saved_rds/myRCTD_reps_nc_im.rds')
...
saveRDS(myRCTD.reps_dm, file = "saved_rds/myRCTD_reps_dm_im.rds")
#myRCTD.reps_dm <- readRDS('saved_rds/myRCTD_reps_dm_im.rds')

#For Rhombencephalon region
# mg not passing cell_type_threshold
cell_types <- c('mesen','tel_NPC','tel_neuron','nc','pns','dien_NPC','dien_neuron','hind_neuron','hind_NPC','choroid_plexus','epi','retina')
...
saveRDS(myRCTD.reps_r, file = "saved_rds/myRCTD_reps_r_im.rds")
#myRCTD.reps_r <- readRDS('saved_rds/myRCTD_reps_r_im.rds')
...
saveRDS(myRCTD.reps_m, file = "saved_rds/myRCTD_reps_m_im.rds")
#myRCTD.reps_m <- readRDS('saved_rds/myRCTD_reps_m_im.rds')
...
saveRDS(myRCTD.reps_e, file = "saved_rds/myRCTD_reps_e_im.rds")
#myRCTD.reps_e <- readRDS('saved_rds/myRCTD_reps_e_im.rds')
...
saveRDS(myRCTD.reps_cp, file = "saved_rds/myRCTD_reps_cp_im.rds")
#myRCTD.reps_cp <- readRDS('saved_rds/myRCTD_reps_cp_im.rds')

#For Telecephalon region
#hind_neuron, hind_NPC, dien_neuron out of bound, mg not passing cell_type_threshold
...
saveRDS(myRCTD.reps_t, file = "saved_rds/myRCTD_reps_t_im.rds")
#myRCTD.reps_t <- readRDS('saved_rds/myRCTD_reps_t_im.rds')
