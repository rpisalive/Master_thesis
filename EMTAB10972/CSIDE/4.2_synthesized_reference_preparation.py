...
adata = sc.read_10x_h5(raw_data_path+'cerebral_organoidsc.h5')
celltype_anno = pd.read_csv(raw_data_path+'EMTAB10974_annotation.csv.gz', index_col=0)
...
adata.obs['celltype'] = celltype_anno['annot_ct'].copy()
#Cell type profiling
...
TE_vis_mat = TE_vis_mat.iloc[:,0:13]
